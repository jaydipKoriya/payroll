                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="faddpayhead.php">
                                    <div class="form-group">
                                        <label for="payHeadName">Pay Head Name</label>
                                        <input type="text" class="form-control" id="payHeadName" name="payhead_name"
                                            placeholder="Enter Pay Head Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="payHeadAmount">Pay Head Amount</label>
                                        <input type="text" class="form-control" id="payHeadAmount" name="payhead_amount"
                                            placeholder="Enter Pay Head Amount">
                                    </div>
                                    <div class="form-group">
                                        <label for="payHeadDescription">Pay Head Description</label>
                                        <textarea class="form-control" id="payHeadDescription" name="payhead_desc"
                                            rows="4" placeholder="Enter Pay Head Description"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Pay Head Type</label>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="payhead_type"
                                                id="earningType" value="earning">
                                            <label class="form-check-label" for="earningType">
                                                Earning
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="payHeadType"
                                                id="deductionType" value="deduction">
