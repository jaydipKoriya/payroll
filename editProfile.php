...
//     $employment_typeg=$row['employment_type'];
...
// } else {
//     echo "Error fetching employee data: " . mysqli_error($connection);
// }
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        <div class="row">
            ...
            <label for="employeePhoto">Upload photo</label>
                <input type="file" class="form-control-file" id="employeePhoto" name="employeePhoto" value="<?= $employee['photo_path']; ?>">
            </div>
            </div>
        </div>
