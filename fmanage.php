                                ...
                                <div class="form-group">
                                  ...
                                  // Assuming you have an established database connection ($conn)
                                      ...
                                      // Retrieve the checkbox values from the database
                                        ...
                                        //         // Display pay head name and amount, but hide the ID
                                        //         echo '<div class="form-check">';
                                        //         echo '<label class="form-check-label" for="' . $payheadId . '">' . $payheadName . '</label>';
                                        //         echo '<br>';
                                        //         echo '<input type="text" name="payheadAmount[]" value="' . $payheadAmount . '">';
                                        //         // Use a hidden input field to store the pay head ID
                                        //         echo '<input type="hidden" name="payheadId[]" value="' . $payheadId . '">';
                                        //         // echo '<label class="form-check-label" for="' . $payheadId . '">' . $payheadName . '</label>';
                                        //         echo '</div>';
                                        //     }
                                         } else {
                                             echo "No payhead records found in the database.";
                                            }
                                         ?>
                                </div>
